...
export const translations = {
  en: {
    ...
    backendOffline: "Backend is not running. Use start-mac.command / start-windows.bat, or run uvicorn main:app --host 127.0.0.1 --port 8789 --reload in backend.",
  ...
  zh: {
    ...
    backendOffline: "后端未启动：请运行 start-mac.command / start-windows.bat，或在 backend 目录执行 uvicorn main:app --host 127.0.0.1 --port 8789 --reload",
